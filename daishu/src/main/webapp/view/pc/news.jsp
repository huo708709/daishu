        ...
        <div class="row">
            ...
            <div class="col-md-9 pull-right">
                <ul class="header-navigation">
                    ...
                    <li class="current"><a href="pc/index/#news">新闻动态</a></li>
        ...
        <div class="row margin-top-30">
        	<div class="col-md-12">
        		<div style="float: left;width: 314px;">
	        		<img src="static/upload/${news.fileId }" style="width: 100%;">
        		</div>
        		<div style="float: left;margin-left: 30px;text-align: left;width: 770px;height: 180px;overflow:hidden;">
        			<h3><a style="color: #313131;font-size: 18px;" href="pc/news_detail?id=${news.id }">${news.title }</a></h3>
