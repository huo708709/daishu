...
<div class="portlet light bg-inverse">
	<div class="portlet-body form">
		<form id="ayi_form" class="form-horizontal" action="daishu/ayi/add" method="post">
			<div class="form-body">
		        ...
		        <div class="form-group">
		            ...
		            <div class="col-sm-4 col-md-5">
		                <input name="cardNo" type="text" placeholder="身份证" class="form-control">
		            </div>
		            <label class="control-label col-sm-2 col-md-1">籍贯</label>
		            <div class="col-sm-4 col-md-5">
		                <input name="cardPlace" type="text" placeholder="籍贯" class="form-control">
		            </div>
		        </div>
		        <div class="form-group">
		            ...
		            <div class="col-sm-4 col-md-5">
		                <input id="ayi_birthday" name="birthday" type="text" placeholder="出生日期" class="form-control">
		            </div>
		        </div>
			</div>
