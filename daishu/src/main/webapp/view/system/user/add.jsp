...
<div class="portlet light bg-inverse">
	<div class="portlet-body form">
		<form id="user_form" class="form-horizontal" action="system/user/add" method="post">
			<div class="form-body">
				...
				<div class="form-group">
		            ...
		            <div class="col-sm-5 col-md-4">
		                <input name="password" type="text" placeholder="密码" class="form-control">
		            </div>
		        </div>
		        <div class="form-group">
		            <label class="control-label col-md-1 col-sm-2">电话号码</label>
		            <div class="col-sm-5 col-md-4">
		                <input name="phone" type="text" placeholder="电话号码" class="form-control">
		            </div>
