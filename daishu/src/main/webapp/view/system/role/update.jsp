...
<div class="portlet light bg-inverse">
	<div class="portlet-body form">
		<form id="role_form" class="form-horizontal" action="system/role/update" method="post">
			...
			<div class="form-body">
				...
				<div class="form-group">
		            ...
		            <div class="col-md-10">
		                <input name="name" value="${role.name}" type="text" placeholder="名称" class="form-control">
		            </div>
		        </div>
		        <div class="form-group">
