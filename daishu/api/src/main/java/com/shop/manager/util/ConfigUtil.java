...
/**
 * https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx2f7d7a7227c84073&redirect_uri=http%3A%2F%2Fdaishuguanjia.cn%2Fapi%2Fauth&response_type=code&scope=snsapi_userinfo#wechat_redirect
 * 
 * @author huoyao
 *
 */
public class ConfigUtil {
	 ...
	 * 服务号相关信息
	 */
	public final static String APPID = "wx2f7d7a7227c84073"; // "wx588b0c22b8e70fdd";//服务号的应用号
	public final static String APP_SECRECT = "18fd1d15184c92bd0b2db7f6559ae0d3";// 服务号的应用密码
	// public final static String TOKEN = "weixinCourse";//服务号的配置token
	public final static String MCH_ID = "1278255301";// 商户号 1315531901
	public final static String API_KEY = "efNgboBdPQCiSSLpRbxA9aAm2RSAuSaO";// API密钥
	public final static String SIGN_TYPE = "MD5";// 签名加密方式
	public final static String CERT_PATH = "D:/apiclient_cert.p12";// 微信支付证书存放路径地址
	// 微信支付统一接口的回调action
	public final static String NOTIFY_URL = "http://daishuguanjia.cn/api/recharge/pay_success";
	public final static String NOTIFY_URL1 = "http://daishuguanjia.cn/api/order/pay_success";
	// 微信支付成功支付后跳转的地址
